...
thread_yield (void) 
{
  ...
  if (cur != idle_thread) 
    ...
    //yield的唤醒的时候，加入ready队列使用按照priority顺序加入
...
//compare the priority of the threadpP of a&b,and if P(a)>P(b) 
//return ture to promise the ready queue is sorted in decreasing list
